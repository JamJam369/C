...
void calcStateTax (struct employee * head_ptr)
{
    ...
    for (current_ptr = head_ptr; current_ptr; current_ptr = current_ptr->next)
    {
        ...
        // TODO - DONE - Add all the missing code to properly update the 
...
void calcFedTax (struct employee * head_ptr)
{
    ...
    // TODO - DONE - Add a for Loop to traverse through the linked list
    //        to calculate the federal tax for each employee

    for (current_ptr = head_ptr; current_ptr; current_ptr = current_ptr->next)
      
    {
         // TODO - DONE - Inside the loop, using current_ptr
                         ...
                         struct totals * emp_totals_ptr)
{
    ...
    for (current_ptr = head_ptr; current_ptr; current_ptr = current_ptr->next)
    {
        ...
        // TODO - DONE - update these two statements below to correctly 
                         ...
                         struct min_max * emp_minMax_ptr)
{
    ...
    for (; current_ptr; current_ptr = current_ptr->next) 
    {
        ...
        // TODO - DONE - Add code to check if the current state tax is our
        ...
        // TODO - DONE - Add code to check if the current federal tax is our
        //        new min and/or max items.   Right now the checks 
        //        are missing.
