...
// TODO - DONE - Create a macro called CALC_FED_TAX.  It will be very similar
...
// TODO - DONE - These two macros are missing the correct logic, they are just setting
...
// TODO - DONE - Add a typedef alias to this structure, call it: MIN_MAX
...
// TODO - DONE - Update these two prototypes with the MIN_MAX typedef alias                              
...
int main ()
{
    ...
    // TODO - DONE - Update these two variable declarations to use
...
// TODO - DONE - Update the emp_MinMax_ptr parameter below to use the MIN_MAX 
//        typedef alias
...
void calcFedTax (EMPLOYEE * head_ptr)
{
    ...
    for (current_ptr = head_ptr; current_ptr; current_ptr = current_ptr->next)
    {
        ...
        // TODO - DONE - Replace the below statement after the "=" with
...
// TODO - DONE - Update the emp_minMax_ptr parameter below to use the
//        the MIN_MAX typedef alias
