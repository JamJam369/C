...
// TODO - DONE - Transition these prototypes from using arrays to
// using pointers (use emp_ptr instead of employeeData for 
// the first parameter). See prototypes above for hints.
...
int main ()
{
    ...
    // TODO - DONE - Transition this call to using pointers.
...
// Parameters: 
//
//   emp_totals_ptr - pointer to array of totals
//   emp_MinMax_ptr - pointer to array of min, and max values      
...
// TODO - DONE - Transition this function from Structure references to
...
// TODO - DONE - Transition this function from Array references to
